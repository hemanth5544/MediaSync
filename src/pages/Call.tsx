...
export const Call = () => {
  ...
  const { localStream, remoteStreams, socket, messages } = useWebRTCCall(callId!, (participantId: string) => {
    console.log(participantId, "iffffffff")
...
//need to checkk wiht the socketss
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#1a1a1a] to-[#2d2d2d] text-white p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        {Object.entries(remoteStreams).map(([socketId, stream]) => (
          <div key={socketId} className="relative bg-[#252525] rounded-xl overflow-hidden border border-[rgba(255,255,255,0.1)] shadow-lg">
